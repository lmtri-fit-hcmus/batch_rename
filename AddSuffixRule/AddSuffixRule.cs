...
{
    public class AddSuffixRule : IPlugin
    {
        public object Handle(Request item)
        {
            switch (item.m_mid)
            {
                 ...
                 * return []
                 * */
                case BrMethods.BR_MID_ADD_SUFFIX_RENAME:
                    ...
                    _AddSuffixRule renameRule = new _AddSuffixRule();
                ...
                * TEMPORARY IMPLEMENT
                * */
                case BrMethods.BR_MID_ADD_SUFFIX_ADD_RULE_CLICK:
                    var cloneRule = new _AddSuffixRule();
        ...
        private class _AddSuffixRule : Window, IRule
        {
            ...
            public _AddSuffixRule(string _rulename, string _ruleDescription, List<string> _parameter,
            ...
            public IRule Clone()
            {
                _AddSuffixRule clone = new _AddSuffixRule();
