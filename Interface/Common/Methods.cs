...
namespace BatchRename
{
    ...
    public static class BrMethods
    {
         ...
         */
        public const string BR_PASCAL_CASE = "PascalCase";
         ...
         */
        public const string BR_REMOVE_ALL_SPACE_FROM_BEGIN_AND_END = "RemoveAllSpaceFromBeginAndEnd";
         ...
         */
        public const string BR_REPLACE_CHARACTERS = "ReplaceCharacters";
